...
namespace WebGrabberExamples
{
    class Program
    {
        public static void Main()
        {
            ...
            // PDF output filename
            webgrabber.NewDocumentName = "WebGrabber.OutputDirectory.pdf";

            // If the output directory is not set using the below line then the
            // output PDF will be located in the WebGrabber temporary
            // directory, C:\ProgramData\activePDF\Temp
