...
namespace WebGrabberExamples
{
    class Program
    {
        public static void Main()
        {
            ...
            webgrabber.NewDocumentName = "WebGrabber.Proxy.pdf";
            webgrabber.OutputDirectory = strPath;

            // Proxy settings in order to access external URL's
            webgrabber.ProxyPortHTTP = "#";
            webgrabber.ProxyServerHTTP = "#.#.#.#";
            webgrabber.ProxyServerUserName = "john.doe";
            webgrabber.ProxyServerPassword = "xxxxxxxx";
