...
namespace WebGrabberExamples
{
    class Program
    {
        public static void Main()
        {
            ...
            // Pass the authentication needed to access the URL. If domain is
            // required it can be passed with the username as shown below
            webgrabber.AuthenticName = "domain\\john.doe";
            webgrabber.AuthenticPassword = "xxxxxxxx";
            ...
            webgrabber.NewDocumentName = "WebGrabber.Authentication.pdf";
