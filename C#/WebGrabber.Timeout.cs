...
namespace WebGrabberExamples
{
    class Program
    {
        public static void Main()
        {
            ...
            webgrabber.NewDocumentName = "WebGrabber.Timeout.pdf";
            webgrabber.OutputDirectory = strPath;

            // Time to wait for conversion to complete (in seconds)
            // The timeout can also be set with webgrabber.Timeout = the number of
            // seconds to wait.
            webgrabber.TimeoutSpan = new TimeSpan(0, 0, 40);
