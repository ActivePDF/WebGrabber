...
namespace WebGrabberExamples
{
    class Program
    {
        public static void Main()
        {
            ...
            webgrabber.NewDocumentName = "WebGrabber.SavePostscript.pdf";
            webgrabber.OutputDirectory = strPath;

            // Save the temporary PostScript file used during conversion
            // Only applies to printer based conversions
            // IE engine only
            webgrabber.SavePostScript = true;
